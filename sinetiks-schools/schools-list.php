        ...
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td>
						<a href="<?php echo admin_url('admin.php?page=sinetiks_schools_update&id=' . $row->id); ?>">Update</a>
						<a href="<?php echo WP_PLUGIN_URL; ?>/sinetiks-schools/delete-user.php?id=<?php echo $row->id; ?>">	Delete
						</a>
					</td>
                </tr>
            <?php } ?>
